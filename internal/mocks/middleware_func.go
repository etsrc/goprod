...
//   - _a0 http.Handler
func (_e *MiddlewareFunc_Expecter) Execute(_a0 interface{}) *MiddlewareFunc_Execute_Call {
	return &MiddlewareFunc_Execute_Call{Call: _e.mock.On("Execute", _a0)}
}

func (_c *MiddlewareFunc_Execute_Call) Run(run func(_a0 http.Handler)) *MiddlewareFunc_Execute_Call {
...
func (_c *MiddlewareFunc_Execute_Call) Return(_a0 http.Handler) *MiddlewareFunc_Execute_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MiddlewareFunc_Execute_Call) RunAndReturn(run func(http.Handler) http.Handler) *MiddlewareFunc_Execute_Call {
	_c.Call.Return(run)
	return _c
}
